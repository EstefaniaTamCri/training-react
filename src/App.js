...
const App = () => {
  ...
  const fetchTasksHandler = async () => {
    ...
    try {
      const response = await fetch(
        "https://task-list-65b47-default-rtdb.europe-west1.firebasedatabase.app/tasks.json",
  ...
  const deleteItemHandler = async (taskId) => {
    ...
    try {
      const response = await fetch(
        `https://task-list-65b47-default-rtdb.europe-west1.firebasedatabase.app/tasks/${taskId}.json`,
        {
          method: "DELETE",
        }
      );
  ...
  const updateItemHandler = async (id,text) => {
    ...
    try {
      const response = await fetch(
        `https://task-list-65b47-default-rtdb.europe-west1.firebasedatabase.app/tasks/${id}.json`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
